...
(/** @lends <global> */function( $ ) {
	...
	DataTable.defaults.column = {
		 ...
		 *          { "data": "browser" },
		 *          { "data": "carpool.inner" },
		 *          { "data": "carpool.details.0" },
		 *          { "data": "carpool.details.1" }
		 *        ]
		 *      } );
		 *    } );
		 *
	...
	DataTable.models.oSettings = {
		...
		"oScroll": {
			...
			/**
			 * Width of the scrollbar for the web-browser's carpool. Calculated
