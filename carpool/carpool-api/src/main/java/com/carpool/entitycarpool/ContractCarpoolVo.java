 ...
 */
public class ContractCarpoolVo implements Serializable {
...
//    private String toAddressName;
    ...
    private String weekNum;//app用，后台不管
    ...
    private int status;//0:新建状态  1:接受合约  11:合约进行中  2:合约取消 3:合约结束(完成) 
    ...
    private List<ContractWarnCarpoolVo> contractWarnList;
	...
	public List<ContractWarnCarpoolVo> getContractWarnList() {
		return contractWarnList;
	}

	public void setContractWarnList(List<ContractWarnCarpoolVo> contractWarnList) {
	...
	public String getTargetIMUserId() {
		return targetIMUserId;
	}

	public void setTargetIMUserId(String targetIMUserId) {
		this.targetIMUserId = targetIMUserId;
	}
