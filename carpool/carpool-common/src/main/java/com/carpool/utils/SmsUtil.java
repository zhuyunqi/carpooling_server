...
public class SmsUtil {
    ...
    public static void main(String[] args) {
        ...
        String phoneNumber = "15008083910";
        sendSMSMessage(message, countryCode, phoneNumber);
	}
	
	public static String sendSMSMessage(String message, String countryCode, String phoneNumber) {
		PublishResult result = AmazonSNSClientBuilder.standard().withCredentials(new ClasspathPropertiesFileCredentialsProvider()).withRegion("us-west-2").build().publish(new PublishRequest()
	            .withMessage(message)
	            .withPhoneNumber(countryCode +phoneNumber));
