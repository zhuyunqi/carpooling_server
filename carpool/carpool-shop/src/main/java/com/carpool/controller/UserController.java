...
import com.carpool.utils.excel.ExcelExport;
...
public class UserController {
    ...
    public R statistical () {
        ...
        int sumToday = userService.queryTotal(params);

        Map<String, Integer> userStatisticalData = new HashMap<String, Integer>();
        userStatisticalData.put("userSum", sum);
        userStatisticalData.put("userSumToday", sumToday);
        return R.ok().put("userStatisticalData", userStatisticalData);
    }
