...
export const AddressList = 'address/list' //地址列表
export const AddressDetail = 'address/detail' //地址详情
export const AddressSave = 'address/save' //保存地址
export const AddressDelete = 'address/delete' //删除地址
