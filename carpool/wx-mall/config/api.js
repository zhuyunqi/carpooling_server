...
module.exports = {
    ...
    AddressList: API_BASE_URL + 'address/list',  //地址列表
    AddressDetail: API_BASE_URL + 'address/detail',  //地址详情
    AddressSave: API_BASE_URL + 'address/save',  //保存地址
